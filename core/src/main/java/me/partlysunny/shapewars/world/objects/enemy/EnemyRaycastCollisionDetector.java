...
public class EnemyRaycastCollisionDetector implements RaycastCollisionDetector<Vector2> {

    World world;
    Box2dRaycastCallback callback;

    public EnemyRaycastCollisionDetector (World world) {
        this(world, new Box2dRaycastCallback());
    }

    public EnemyRaycastCollisionDetector (World world, Box2dRaycastCallback callback) {
        this.world = world;
